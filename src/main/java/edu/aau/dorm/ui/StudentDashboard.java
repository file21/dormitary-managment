...
public class StudentDashboard {
    ...
    public StudentDashboard(DormService service, Student student) {
    ...
    private Tab createMessagesTab() {
        ...
        recipientBox.setItems(FXCollections.observableArrayList(
                service.getUsersByRole(edu.aau.dorm.model.Role.ADMIN).stream().map(user -> user.getUsername()).collect(Collectors.toList())
        ));
